...
var author$project$Cell$Alive = function (a) {
	return {$: 'Alive', a: a};
};
...
var author$project$Patterns$all = _List_fromArray(
	[
...
var author$project$Patterns$get = function (name) {
...
var author$project$RLE$mapMatchToGroup = function (_n0) {
	var submatches = _n0.submatches;
	_n1$2:
	while (true) {
		if (submatches.b && submatches.b.b) {
			if (submatches.b.a.$ === 'Just') {
				if ((submatches.b.b.b && (submatches.b.b.a.$ === 'Just')) && (!submatches.b.b.b.b)) {
					var _n2 = submatches.b;
					var nb = _n2.a.a;
					var _n3 = _n2.b;
					var status = _n3.a.a;
				...
				if ((submatches.b.b.b && (submatches.b.b.a.$ === 'Just')) && (!submatches.b.b.b.b)) {
					var _n4 = submatches.b;
					var _n5 = _n4.a;
					var _n6 = _n4.b;
					var status = _n6.a.a;
					return _Utils_Tuple2(1, status === 'o');
				} else {
					break _n1$2;
				}
			}
...
var author$project$RLE$splitGroups = A2(
	elm$core$Maybe$withDefault,
	elm$regex$Regex$never,
	elm$regex$Regex$fromString('((\\d*)([ob]))'));
...
var author$project$RLE$splitRow = F2(
	function (rowIndex, row) {
		var matches = A2(elm$regex$Regex$find, author$project$RLE$splitGroups, row);
		var groups = A2(elm$core$List$map, author$project$RLE$mapMatchToGroup, matches);
		var rowCells = A3(
			elm$core$List$foldr,
			...
			A2(
				...
				function (_n2) {
					var nb = _n2.a;
					var alive = _n2.b;
					return A2(elm$core$List$repeat, nb, alive);
				},
				groups));
		return A2(
			elm$core$List$map,
			...
			A2(
				...
				A2(
					...
					F2(
						function (colIndex, alive) {
							return _Utils_Tuple3(colIndex, rowIndex, alive);
						}),
					rowCells)));
	});
...
var author$project$RLE$decode = function (rle) {
	return A3(
		elm$core$List$foldr,
		elm$core$Basics$append,
		_List_Nil,
		A2(
			elm$core$List$indexedMap,
			author$project$RLE$splitRow,
			A2(elm$core$String$split, '$', rle)));
};
...
var author$project$Board$generateFromPattern = F2(
	function (_n0, patternName) {
		var offsetX = _n0.a;
		var offsetY = _n0.b;
		return A2(
			elm$core$List$map,
			function (pos) {
				return author$project$Cell$Alive(pos);
			},
			A2(
				elm$core$List$map,
				function (pos) {
					return A3(
						...
						elm$core$Basics$add(offsetX),
						elm$core$Basics$add(offsetY),
						pos);
				},
				A2(
					elm$core$Maybe$withDefault,
					...
					A2(
						...
						A2(
							...
							author$project$Patterns$get(patternName))))));
	});
var author$project$Main$initialModel = {
	board: A2(
		author$project$Board$generateFromPattern,
		_Utils_Tuple2(10, 10),
		'Octagon2'),
	generation: 0,
	simSpeed: 0,
	viewSize: _Utils_Tuple2(800, 600)
};
...
var author$project$Core$Evolve = {$: 'Evolve'};
...
var author$project$Main$subscriptions = function (_n0) {
	...
	if (!simSpeed) {
		...
		return A2(
			...
			1000 / simSpeed,
			function (_n2) {
				return author$project$Core$Evolve;
			});
	}
};
var author$project$Cell$isAlive = function (cell) {
	if (cell.$ === 'Alive') {
		return true;
	} else {
		return false;
...
var author$project$Board$getAliveCells = elm$core$List$filter(author$project$Cell$isAlive);
var author$project$Cell$getPos = function (cell) {
	if (cell.$ === 'Alive') {
		var pos = cell.a;
		return pos;
	} else {
...
var author$project$Cell$distanceTo = F2(
	function (a, b) {
		var _n0 = author$project$Cell$getPos(b);
		var xb = _n0.a;
		var yb = _n0.b;
		var _n1 = author$project$Cell$getPos(a);
		var xa = _n1.a;
		var ya = _n1.b;
		var _n2 = _Utils_Tuple2(
			elm$core$Basics$abs(xa - xb),
			elm$core$Basics$abs(ya - yb));
		var xDiff = _n2.a;
		var yDiff = _n2.b;
		return A2(elm$core$Basics$max, xDiff, yDiff);
	});
var author$project$Cell$neighbours = F2(
	function (a, b) {
		return A2(author$project$Cell$distanceTo, a, b) === 1;
	});
var author$project$Board$getNeighbours = F2(
	function (board, cell) {
		return A2(
			elm$core$List$filter,
			author$project$Cell$neighbours(cell),
			board);
	});
var author$project$Board$getAliveNeighbours = F2(
	function (board, cell) {
		var result = A2(
			author$project$Board$getNeighbours,
			author$project$Board$getAliveCells(board),
			cell);
		return result;
	});
var author$project$Cell$Dead = function (a) {
	return {$: 'Dead', a: a};
};
var author$project$Board$evolveCell = F2(
	function (board, cell) {
		var pos = author$project$Cell$getPos(cell);
		var nbAliveNeighbours = elm$core$List$length(
			A2(author$project$Board$getAliveNeighbours, board, cell));
		var evolvedCell = function () {
			switch (nbAliveNeighbours) {
				case 3:
					return author$project$Cell$Alive(pos);
				case 2:
					return cell;
				default:
					return author$project$Cell$Dead(pos);
			}
		}();
		return evolvedCell;
	});
...
var author$project$Board$hasCellAtPos = F2(
	function (board, pos) {
		return A2(
			elm$core$List$any,
			function (c) {
				return _Utils_eq(
					pos,
					author$project$Cell$getPos(c));
			},
			board);
	});
var author$project$Cell$neighboursOffsets = _List_fromArray(
	[
		_Utils_Tuple2(-1, -1),
		_Utils_Tuple2(-1, 0),
		_Utils_Tuple2(-1, 1),
...
var author$project$Cell$generateDeadNeighbours = function (cell) {
	var _n0 = author$project$Cell$getPos(cell);
	var x = _n0.a;
	var y = _n0.b;
	return A2(
		elm$core$List$map,
		function (_n1) {
			var dx = _n1.a;
			var dy = _n1.b;
			return author$project$Cell$Dead(
				_Utils_Tuple2(dx + x, dy + y));
		},
		author$project$Cell$neighboursOffsets);
};
var elm$core$Basics$not = _Basics_not;
var author$project$Board$surroundWithDeadCells = F2(
	function (existingCells, cell) {
		return A2(
			elm$core$List$filter,
			function (c) {
				return !A2(
					author$project$Board$hasCellAtPos,
					existingCells,
					author$project$Cell$getPos(c));
			},
			author$project$Cell$generateDeadNeighbours(cell));
	});
...
var author$project$Utils$consIfNotMember = F2(
	function (el, list) {
		return A2(elm$core$List$member, el, list) ? list : A2(elm$core$List$cons, el, list);
	});
var author$project$Utils$removeDuplicates = A2(elm$core$List$foldr, author$project$Utils$consIfNotMember, _List_Nil);
var author$project$Board$updateDeadCells = function (board) {
	var aliveCells = author$project$Utils$removeDuplicates(
		author$project$Board$getAliveCells(board));
	var deadCells = author$project$Utils$removeDuplicates(
		A3(
			elm$core$List$foldr,
			elm$core$Basics$append,
			_List_Nil,
			A2(
				elm$core$List$map,
				author$project$Board$surroundWithDeadCells(aliveCells),
				aliveCells)));
	return _Utils_ap(aliveCells, deadCells);
};
var author$project$Board$evolve = function (board) {
	var newBoard = author$project$Board$updateDeadCells(board);
	return A2(
		elm$core$List$filter,
		author$project$Cell$isAlive,
		A2(
			elm$core$List$map,
			author$project$Board$evolveCell(newBoard),
			newBoard));
};
var elm$core$Basics$neq = _Utils_notEqual;
var author$project$Board$toggleCell = F2(
	function (pos, board) {
		var aliveCells = author$project$Board$getAliveCells(board);
		return A2(author$project$Board$hasCellAtPos, aliveCells, pos) ? A2(
			elm$core$List$filter,
			function (c) {
				return !_Utils_eq(
					author$project$Cell$getPos(c),
	...
	function (msg, model) {
		switch (msg.$) {
			case 'Reset':
				return _Utils_Tuple2(author$project$Main$initialModel, elm$core$Platform$Cmd$none);
			case 'Evolve':
				var newBoard = author$project$Board$evolve(model.board);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{board: newBoard, generation: model.generation + 1}),
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							board: A2(author$project$Board$toggleCell, pos, model.board)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Core$CanvasClick = function (a) {
...
var author$project$Render$clearScreen = function (_n0) {
	var width = _n0.a;
	var height = _n0.b;
	return A2(
...
var author$project$Render$mousePos = A3(
...
var author$project$Render$onCanvasClick = function (tagger) {
	return A2(
		elm$html$Html$Events$on,
		'click',
		A2(elm$json$Json$Decode$map, tagger, author$project$Render$mousePos));
};
var author$project$Render$mapPositionToPoint = F2(
	function (factor, _n0) {
		var x = _n0.a;
		var y = _n0.b;
		return _Utils_Tuple2(x * factor, y * factor);
	});
var author$project$Render$renderCell = F3(
	function (factor, coverage, cell) {
		if (cell.$ === 'Alive') {
			var pos = cell.a;
			var size = factor * coverage;
			var point = A2(author$project$Render$mapPositionToPoint, factor, pos);
			return elm$core$Maybe$Just(
				A3(joakin$elm_canvas$Canvas$rect, point, size, size));
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
...
var author$project$Render$renderCells = F3(
	function (factor, coverage, cells) {
		return A2(
			elm$core$List$filterMap,
			A2(author$project$Render$renderCell, factor, coverage),
			cells);
	});
var avh4$elm_color$Color$black = A4(avh4$elm_color$Color$RgbaSpace, 0 / 255, 0 / 255, 0 / 255, 1.0);
var author$project$Render$renderBoard = function (factor) {
	return A2(
		...
		A2(author$project$Render$renderCells, factor, 0.8));
};
...
var author$project$Render$viewBoard = F2(
	function (model, factor) {
		var clickHandler = function (_n0) {
			var x = _n0.a;
			var y = _n0.b;
			var posY = elm$core$Basics$floor(y / factor);
			var posX = elm$core$Basics$floor(x / factor);
			return author$project$Core$CanvasClick(
		...
		return A3(
			...
			_List_fromArray(
				[
					author$project$Render$onCanvasClick(clickHandler)
				]),
			_List_fromArray(
				[
					author$project$Render$clearScreen(model.viewSize),
					A2(author$project$Render$renderBoard, factor, model.board)
				]));
	});
var author$project$Board$getPopulation = A2(elm$core$Basics$composeL, elm$core$List$length, author$project$Board$getAliveCells);
var elm$html$Html$footer = _VirtualDom_node('footer');
var elm$html$Html$span = _VirtualDom_node('span');
var elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var elm$html$Html$text = elm$virtual_dom$VirtualDom$text;
var author$project$Render$viewStatusBar = function (model) {
	var simSpeed = function () {
		var _n0 = model.simSpeed;
		if (!_n0) {
			return 'Paused';
		} else {
			var s = _n0;
			return 'x' + elm$core$String$fromInt(s);
		}
	}();
	var population = elm$core$String$fromInt(
		author$project$Board$getPopulation(model.board));
	var generation = elm$core$String$fromInt(model.generation);
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Generation: ' + generation)
					])),
				A2(
				elm$html$Html$span,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Sim. speed: ' + simSpeed)
					])),
				A2(
				elm$html$Html$span,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text('Population: ' + population)
					]))
			]));
};
var author$project$Core$Reset = {$: 'Reset'};
var author$project$Core$SetSpeed = function (a) {
	return {$: 'SetSpeed', a: a};
};
...
var author$project$Render$viewSpeedButton = F2(
	function (curSpeed, forSpeed) {
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('speed-btn', true),
							_Utils_Tuple2(
							'active',
							_Utils_eq(curSpeed, forSpeed))
						])),
					elm$html$Html$Events$onClick(
					author$project$Core$SetSpeed(forSpeed))
				]),
			_List_fromArray(
				[
					elm$html$Html$text(
					elm$core$String$fromInt(forSpeed))
				]));
	});
var elm$html$Html$fieldset = _VirtualDom_node('fieldset');
var elm$html$Html$legend = _VirtualDom_node('legend');
var author$project$Render$viewSpeedButtons = function (speed) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Sim. speed')
					])),
				A2(author$project$Render$viewSpeedButton, speed, 0),
				A2(author$project$Render$viewSpeedButton, speed, 1),
				A2(author$project$Render$viewSpeedButton, speed, 10),
				A2(author$project$Render$viewSpeedButton, speed, 50)
			]));
};
var elm$html$Html$div = _VirtualDom_node('div');
var author$project$Render$viewToolbar = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Core$Evolve)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Core$Reset)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Reset')
					])),
				author$project$Render$viewSpeedButtons(model.simSpeed)
			]));
};
var author$project$Render$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				author$project$Render$viewToolbar(model),
				A2(author$project$Render$viewBoard, model, factor),
				author$project$Render$viewStatusBar(model)
			]));
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{init: author$project$Main$init, subscriptions: author$project$Main$subscriptions, update: author$project$Main$update, view: author$project$Render$view});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Core.Msg","aliases":{},"unions":{"Core.Msg":{"args":[],"tags":{"Evolve":[],"Reset":[],"SetSpeed":["Basics.Int"],"CanvasClick":["( Basics.Int, Basics.Int )"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});
