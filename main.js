...
var author$project$Main$setCellType = F3(
	function (alivePositions, x, y) {
		return A2(
			elm$core$List$member,
			_Utils_Tuple2(x, y),
			alivePositions) ? author$project$Main$Alive : author$project$Main$Dead;
	});
var author$project$Main$makeBoard = F3(
	function (width, height, positionsOfAliveCells) {
		return A3(
			Kraxorax$elm_matrix_a$Matrix$generate,
			width,
			height,
			author$project$Main$setCellType(positionsOfAliveCells));
	});
var author$project$Main$makeStartingBoard = A3(
	author$project$Main$makeBoard,
	10,
	10,
	_List_fromArray(
		[
...
var author$project$Main$initialModel = {board: author$project$Main$makeStartingBoard, generation: 0};
...
var Kraxorax$elm_matrix_a$Neighbours$Plane = {$: 'Plane'};
...
var author$project$Main$evolveCell = F4(
	function (board, x, y, cell) {
		var cellAliveNeighbours = elm$core$Array$length(
			A2(
				elm$core$Array$filter,
				function (c) {
					return _Utils_eq(c, author$project$Main$Alive);
				},
				A4(Kraxorax$elm_matrix_a$Neighbours$neighbours, Kraxorax$elm_matrix_a$Neighbours$Plane, x, y, board)));
		switch (cellAliveNeighbours) {
			case 3:
				return author$project$Main$Alive;
			case 2:
				return cell;
			default:
				return author$project$Main$Dead;
		}
	});
var author$project$Main$evolve = function (board) {
	return A2(
		Kraxorax$elm_matrix_a$Matrix$indexedMap,
		author$project$Main$evolveCell(board),
		board);
};
var author$project$Main$update = F2(
	function (msg, model) {
		return _Utils_update(
			model,
			{
				board: author$project$Main$evolve(model.board),
				generation: model.generation + 1
			});
	});
var Kraxorax$elm_matrix_a$Matrix$width = function (_n0) {
	var w = _n0.a;
	return w;
};
...
var author$project$Main$viewCell = function (cell) {
	if (cell.$ === 'Alive') {
		return A2(
			elm$html$Html$td,
			_List_Nil,
...
var author$project$Main$viewBoardRow = function (cells) {
	return A2(
		elm$html$Html$tr,
		_List_Nil,
		A2(elm$core$List$map, author$project$Main$viewCell, cells));
};
...
var author$project$Main$viewBoard = function (board) {
	var height = Kraxorax$elm_matrix_a$Matrix$height(board);
	var rows = A2(
		elm$core$List$map,
		function (r) {
			if (r.$ === 'Err') {
				return A2(
					...
					Kraxorax$elm_matrix_a$Matrix$width(board),
					author$project$Main$Dead);
			} else {
				var cells = r.a;
				return elm$core$Array$toList(cells);
			}
		},
		A2(
			elm$core$List$map,
			function (r) {
				return A2(Kraxorax$elm_matrix_a$Matrix$getRow, r, board);
			},
			A2(elm$core$List$range, 0, height - 1)));
	return A2(
		elm$html$Html$table,
		_List_Nil,
		A2(elm$core$List$map, author$project$Main$viewBoardRow, rows));
};
var author$project$Main$Evolve = {$: 'Evolve'};
...
var author$project$Main$viewToolbar = function (generation) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Generation #' + elm$core$String$fromInt(generation))
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$Evolve)
					]),
				_List_fromArray(
					[
...
var author$project$Main$view = function (_n0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$viewToolbar(generation),
